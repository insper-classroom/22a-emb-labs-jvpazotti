...
LV_FONT_DECLARE(dseg70_2);
LV_FONT_DECLARE(dseg70_3);
...
void lv_termostato(void) {
	...
	lv_obj_set_style_text_font(labelSetValue, &dseg70_2, LV_STATE_DEFAULT);
	...
	lv_obj_set_style_text_font(labelClock, &dseg70_3, LV_STATE_DEFAULT);
	lv_obj_set_style_text_color(labelClock, lv_color_white(), LV_STATE_DEFAULT);
	lv_label_set_text_fmt(labelClock, "%02d%02d", 17,30);
